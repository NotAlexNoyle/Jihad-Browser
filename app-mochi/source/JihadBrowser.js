...
// Reload icon: the only toolbar glyph that needs a circle, which this engine
// cannot draw in CSS (border-radius:50% renders as a square here), so it is a
// crisp PNG. A persona can recolour it via CSS filter or swap this data URI.
enyo.JihadReloadIcon = "data:image/png;base64,";
...
enyo.kind({
	...
	components: [
		...
		{kind: "FittableColumns", name: "actionBar", classes: "jihad-actionbar", components: [
			{name: "back", classes: "jihad-nav-btn jihad-ic-back disabled", ontap: "goBack"},
			{name: "forward", classes: "jihad-nav-btn jihad-ic-forward disabled", ontap: "goForward"},
			{name: "reload", classes: "jihad-nav-btn", allowHtml: true, content: "<img class=jihad-nav-img src='" + enyo.JihadReloadIcon + "'>", ontap: "reloadPage"},
			{name: "stop", classes: "jihad-nav-btn jihad-ic-stop", ontap: "stopLoad", showing: false},
			...
			{name: "menu", classes: "jihad-nav-btn jihad-ic-menu", ontap: "openMenu"}
		]},
	...
	showStartPage: function() {
		var html = "<!doctype html><html><head><meta charset=utf-8>"
			...
			+ "<h1>Jihad Browser</h1>"
			+ "<div class=sub id=eng>Mochi UI &#9733; UXP/Goanna engine</div>"
			+ "<script>var m=navigator.userAgent.match(/Goanna\\S+ UXP\\S+/);if(m)document.getElementById('eng').textContent='Mochi UI \\u2605 '+m[0];</script>"
			+ "</body></html>";
