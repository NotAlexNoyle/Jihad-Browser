...
enyo.kind({
	...
	components: [
		{name: "bookmarksService", kind: "DbService", dbKind: "net.riverstonerelay.jihad-browser.bookmarks:1", reCallWatches: true, method: "find", onSuccess: "gotBookmarksData", subscribe: true, onWatch:"refreshList"},
