...
enyo.kind({
	...
	components: [
		{name: "historyService", kind: "DbService", dbKind: "net.riverstonerelay.jihad-browser.history:1", reCallWatches: true, method: "find", onSuccess: "gotHistoryData", subscribe: true, onWatch:"refreshList"},
