...
$CXX $CXXFLAGS $INCS -c "$SRC/test/coord_test.cpp"  -o /out/coord_test.o       || exit 12
$CXX /out/coord_test.o /out/GoannaRenderPage.o /out/EngineHost.o /out/DialogService.o /out/DownloadService.o \
