...
echo "== compiling GoannaRenderPage + coordmap_test =="
set -x
...
$CXX $CXXFLAGS $INCS -c "$SRC/test/coordmap_test.cpp"   -o /out/coordmap_test.o       || exit 13
$CXX /out/coordmap_test.o /out/BrowserPageGoanna.o /out/JihadCertStore.o /out/GoannaRenderPage.o /out/EngineHost.o /out/DialogService.o /out/DownloadService.o \
