...
# Build + run the download / MIME-handoff test (domain G R4) against the engine.
set -uo pipefail
DIST=/out/obj-jihad-goanna/dist
SRC=/jihad/render/goanna
OUT=/out/download_test
...
$CXX $CXXFLAGS $INCS -c "$SRC/test/download_test.cpp"  -o /out/download_test.o    || exit 13
$CXX /out/download_test.o /out/GoannaRenderPage.o /out/DialogService.o /out/DownloadService.o /out/EngineHost.o \
