...
echo "== compiling GoannaRenderPage + fail_test =="
set -x
...
$CXX /out/fail_test.o /out/BrowserPageGoanna.o /out/JihadCertStore.o /out/GoannaRenderPage.o /out/EngineHost.o /out/DialogService.o /out/DownloadService.o \
