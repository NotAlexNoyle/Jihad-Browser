...
echo "== compiling GoannaRenderPage + find_test =="
set -x
...
$CXX $CXXFLAGS $INCS -c "$SRC/test/find_test.cpp"   -o /out/find_test.o       || exit 13
$CXX /out/find_test.o /out/BrowserPageGoanna.o /out/JihadCertStore.o /out/GoannaRenderPage.o /out/EngineHost.o /out/DialogService.o /out/DownloadService.o \
