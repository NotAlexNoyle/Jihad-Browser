...
echo "== compiling GoannaRenderPage + geo_test =="
set -x
...
$CXX $CXXFLAGS $INCS -c "$SRC/test/geo_test.cpp"   -o /out/geo_test.o       || exit 13
$CXX /out/geo_test.o /out/BrowserPageGoanna.o /out/JihadCertStore.o /out/GoannaRenderPage.o /out/EngineHost.o /out/DialogService.o /out/DownloadService.o \
