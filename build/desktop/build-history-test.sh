...
$CXX $CXXFLAGS $INCS -c "$SRC/test/history_test.cpp"  -o /out/history_test.o       || exit 12
$CXX /out/history_test.o /out/GoannaRenderPage.o /out/EngineHost.o /out/DialogService.o /out/DownloadService.o \
