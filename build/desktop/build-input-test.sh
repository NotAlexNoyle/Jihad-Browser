...
$CXX $CXXFLAGS $INCS -c "$SRC/test/input_test.cpp"  -o /out/input_test.o       || exit 12
$CXX /out/input_test.o /out/GoannaRenderPage.o /out/EngineHost.o /out/DialogService.o /out/DownloadService.o \
