...
echo "== compiling GoannaRenderPage + input2_test =="
set -x
...
$CXX $CXXFLAGS $INCS -c "$SRC/test/input2_test.cpp"   -o /out/input2_test.o       || exit 13
$CXX /out/input2_test.o /out/BrowserPageGoanna.o /out/JihadCertStore.o /out/GoannaRenderPage.o /out/EngineHost.o /out/DialogService.o /out/DownloadService.o \
