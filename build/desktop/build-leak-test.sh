...
$CXX $CXXFLAGS $INCS -c "$SRC/test/leak_test.cpp"  -o /out/leak_test.o       || exit 12
$CXX /out/leak_test.o /out/GoannaRenderPage.o /out/EngineHost.o /out/DialogService.o /out/DownloadService.o \
