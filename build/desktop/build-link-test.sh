...
INCS="-include $DIST/include/mozilla-config.h -I$DIST/include -I$DIST/include/nspr -I$SRC/../browserserver/Src $GTK_CFLAGS"

echo "== compiling GoannaRenderPage + link_test =="
set -x
...
$CXX $CXXFLAGS $INCS -c "$SRC/JihadCertStore.cpp"   -o /out/JihadCertStore.o  || exit 11
...
$CXX $CXXFLAGS $INCS -c "$SRC/test/link_test.cpp"   -o /out/link_test.o       || exit 13
$CXX /out/link_test.o /out/BrowserPageGoanna.o /out/JihadCertStore.o /out/GoannaRenderPage.o /out/EngineHost.o /out/DialogService.o /out/DownloadService.o \
