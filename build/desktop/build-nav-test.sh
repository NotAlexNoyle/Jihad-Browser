...
$CXX $CXXFLAGS $INCS -c "$SRC/test/nav_test.cpp"  -o /out/nav_test.o       || exit 12
$CXX /out/nav_test.o /out/GoannaRenderPage.o /out/EngineHost.o /out/DialogService.o /out/DownloadService.o \
