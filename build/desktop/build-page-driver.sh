...
echo "== compiling GoannaRenderPage + driver =="
set -x
...
$CXX $CXXFLAGS $INCS -c "$SRC/test/page_driver.cpp"   -o /out/page_driver.o       || exit 13
$CXX /out/page_driver.o /out/BrowserPageGoanna.o /out/JihadCertStore.o /out/GoannaRenderPage.o /out/EngineHost.o /out/DialogService.o /out/DownloadService.o \
