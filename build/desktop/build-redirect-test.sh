...
echo "== compiling GoannaRenderPage + redirect_test =="
set -x
...
$CXX $CXXFLAGS $INCS -c "$SRC/test/redirect_test.cpp"   -o /out/redirect_test.o       || exit 13
$CXX /out/redirect_test.o /out/BrowserPageGoanna.o /out/JihadCertStore.o /out/GoannaRenderPage.o /out/EngineHost.o /out/DialogService.o /out/DownloadService.o \
