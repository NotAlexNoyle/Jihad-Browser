...
$CXX $CXXFLAGS $INCS -c "$SRC/test/resize_test.cpp"  -o /out/resize_test.o       || exit 12
$CXX /out/resize_test.o /out/GoannaRenderPage.o /out/EngineHost.o /out/DialogService.o /out/DownloadService.o \
