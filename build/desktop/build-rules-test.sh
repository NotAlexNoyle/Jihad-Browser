...
echo "== compiling GoannaRenderPage + rules_test =="
set -x
...
$CXX $CXXFLAGS $INCS -c "$SRC/test/rules_test.cpp"   -o /out/rules_test.o       || exit 13
$CXX /out/rules_test.o /out/BrowserPageGoanna.o /out/JihadCertStore.o /out/GoannaRenderPage.o /out/EngineHost.o /out/DialogService.o /out/DownloadService.o \
