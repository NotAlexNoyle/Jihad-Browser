...
$CXX $CXXFLAGS $INCS -c "$SRC/test/scroll_test.cpp"  -o /out/scroll_test.o       || exit 12
$CXX /out/scroll_test.o /out/GoannaRenderPage.o /out/EngineHost.o /out/DialogService.o /out/DownloadService.o \
