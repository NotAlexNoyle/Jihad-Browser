...
$CXX $CXXFLAGS $INCS -c "$SRC/test/settings2_test.cpp"  -o /out/settings2_test.o       || exit 12
$CXX /out/settings2_test.o /out/GoannaRenderPage.o /out/EngineHost.o /out/DialogService.o /out/DownloadService.o \
