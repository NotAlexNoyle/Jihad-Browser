...
- [~] The build also produces the Mochi variant `.ipk` (`net.riverstonerelay.jihad-browser.mochi`, from `app-mochi/`); both install and can coexist. *(Produced 2026-07-19: `build-mochi-ipk.sh` → 1.4 MB ipk, verified payload. Dual INSTALL still DEVICE-GATED — device offline.)*
