...
|------|------|-------|------|--------|
| Jihad Browser port | build-site.md | 54 | 0 | READY |

Phase 1 (desktop x86_64 PoC): all tasks except the device track.
Phase 2 (webOS ARMv7): T-011, T-018, T-046, T-047, T-048, T-054.
Two UI variants (Enyo `app/`, Mochi `app-mochi/`) → two `.ipk`s for TouchPad + TouchPad Go.
